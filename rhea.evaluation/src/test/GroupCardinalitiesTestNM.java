...
@RunWith(Suite.class)
@SuiteClasses({})
public class GroupCardinalitiesTestNM {
	...
	void cardinalitiesGroup(String inputModel) throws IOException {
		...
		String ruleName = "GroupCardinalitiesNM";
		...
		Module module = null;
		String transformationFilePathCompleted = null;
		try {
			module = GroupCardinalities.completeModuleForGC(transformationFilepath, gcs.get(0));
			transformationFilePathCompleted = Rhea.REFACTORINGS_DIR + module.getName() + ".henshin";
		...
		module = henshin.getModule(transformationFilePathCompleted);
