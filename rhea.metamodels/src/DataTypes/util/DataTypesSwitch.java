...
public class DataTypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DataTypesPackage.PRIMITIVE_TYPE: {
			...
			case DataTypesPackage.TYPED_FEATURE: {
				TypedFeature typedFeature = (TypedFeature)theEObject;
				T result = caseTypedFeature(typedFeature);
				if (result == null) result = caseFeature(typedFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataTypesPackage.VALUE: {
			...
			case DataTypesPackage.NON_TRADITIONAL_FM: {
				NonTraditionalFM nonTraditionalFM = (NonTraditionalFM)theEObject;
				T result = caseNonTraditionalFM(nonTraditionalFM);
				if (result == null) result = caseFeatureModel(nonTraditionalFM);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Non Traditional FM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Non Traditional FM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNonTraditionalFM(NonTraditionalFM object) {
		return null;
	}
