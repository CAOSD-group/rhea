 ...
 * @generated
 */
public class BasicCTCsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicCTCsPackage.REQUIRES: {
			...
			case BasicCTCsPackage.EXCLUDES: {
			...
			case BasicCTCsPackage.BASIC_CONSTRAINT: {
