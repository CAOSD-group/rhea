/**
 */
package uma.caosd.rhea.metamodels.BasicFMs.impl;
...
import uma.caosd.rhea.metamodels.BasicFMs.CrossTreeConstraint;
 ...
 * </p>
 * <ul>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureModelImpl#getRoot <em>Root</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureModelImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureModelImpl#getCrosstreeconstraints <em>Crosstreeconstraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureModelImpl extends MinimalEObjectImpl.Container implements FeatureModel {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BasicFMsPackage.FEATURE_MODEL___GET_FEATURE__STRING:
