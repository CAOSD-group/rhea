...
import uma.caosd.rhea.metamodels.CardinalityBasedFMs.CardinalityBasedFMsFactory;
...
public class CardinalityBasedFMsPackageImpl extends EPackageImpl implements CardinalityBasedFMsPackage {
	 ...
	 * @see uma.caosd.rhea.metamodels.CardinalityBasedFMs.CardinalityBasedFMsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMultiplicity_Lower(), ecorePackage.getEInt(), "lower", "0", 1, 1, Multiplicity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
