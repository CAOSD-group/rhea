 ...
 * @generated
 */
public class CardinalityBasedFMsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public CardinalityBasedFMsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CardinalityBasedFMsPackage.MULTIPLICITY: {
				Multiplicity multiplicity = (Multiplicity)theEObject;
				T result = caseMultiplicity(multiplicity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CardinalityBasedFMsPackage.GROUP_CARDINALITY: {
