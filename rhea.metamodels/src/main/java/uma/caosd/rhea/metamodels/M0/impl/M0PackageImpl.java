...
import uma.caosd.rhea.metamodels.M0.AlternativeGroup;
import uma.caosd.rhea.metamodels.M0.CrossTreeConstraint;
import uma.caosd.rhea.metamodels.M0.Feature;
import uma.caosd.rhea.metamodels.M0.FeatureGroup;
import uma.caosd.rhea.metamodels.M0.FeatureModel;
import uma.caosd.rhea.metamodels.M0.M0Factory;
import uma.caosd.rhea.metamodels.M0.M0Package;
import uma.caosd.rhea.metamodels.M0.SelectionGroup;
 ...
 * @generated
 */
public class M0PackageImpl extends EPackageImpl implements M0Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uma.caosd.rhea.metamodels.M0.M0Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private M0PackageImpl() {
		super(eNS_URI, M0Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link M0Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static M0Package init() {
		if (isInited) return (M0Package)EPackage.Registry.INSTANCE.getEPackage(M0Package.eNS_URI);

		// Obtain or create and register package
		Object registeredM0Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		M0PackageImpl theM0Package = registeredM0Package instanceof M0PackageImpl ? (M0PackageImpl)registeredM0Package : new M0PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theM0Package.createPackageContents();

		// Initialize created meta-data
		theM0Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theM0Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(M0Package.eNS_URI, theM0Package);
		return theM0Package;
	}
	 ...
	 * @generated
	 */
	public M0Factory getM0Factory() {
		return (M0Factory)getEFactoryInstance();
	}
