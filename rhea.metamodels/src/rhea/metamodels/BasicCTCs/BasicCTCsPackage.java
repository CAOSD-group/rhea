 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see rhea.metamodels.BasicCTCs.BasicCTCsFactory
 * @model kind="package"
 * @generated
 */
public interface BasicCTCsPackage extends EPackage {
	 ...
	 * @generated
	 */
	BasicCTCsPackage eINSTANCE = rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl.init();

	/**
	 * The meta object id for the '{@link rhea.metamodels.BasicCTCs.impl.BasicConstraintImpl <em>Basic Constraint</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see rhea.metamodels.BasicCTCs.impl.BasicConstraintImpl
	 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getBasicConstraint()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link rhea.metamodels.BasicCTCs.impl.RequiresImpl <em>Requires</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see rhea.metamodels.BasicCTCs.impl.RequiresImpl
	 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getRequires()
	 * @generated
	 */
	int REQUIRES = 0;
	...
	/**
	 * The meta object id for the '{@link rhea.metamodels.BasicCTCs.impl.ExcludesImpl <em>Excludes</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see rhea.metamodels.BasicCTCs.impl.ExcludesImpl
	 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getExcludes()
	 * @generated
	 */
	int EXCLUDES = 1;
	...
	/**
	 * Returns the meta object for class '{@link rhea.metamodels.BasicCTCs.Requires <em>Requires</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Requires</em>'.
	 * @see rhea.metamodels.BasicCTCs.Requires
	 * @generated
	 */
	EClass getRequires();

	/**
	 * Returns the meta object for class '{@link rhea.metamodels.BasicCTCs.Excludes <em>Excludes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Excludes</em>'.
	 * @see rhea.metamodels.BasicCTCs.Excludes
	 * @generated
	 */
	EClass getExcludes();

	/**
	 * Returns the meta object for class '{@link rhea.metamodels.BasicCTCs.BasicConstraint <em>Basic Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Basic Constraint</em>'.
	 * @see rhea.metamodels.BasicCTCs.BasicConstraint
	 * @generated
	 */
	EClass getBasicConstraint();

	/**
	 * Returns the meta object for the reference '{@link rhea.metamodels.BasicCTCs.BasicConstraint#getLeftFeature <em>Left Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Left Feature</em>'.
	 * @see rhea.metamodels.BasicCTCs.BasicConstraint#getLeftFeature()
	...
	/**
	 * Returns the meta object for the reference '{@link rhea.metamodels.BasicCTCs.BasicConstraint#getRightFeature <em>Right Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Right Feature</em>'.
	 * @see rhea.metamodels.BasicCTCs.BasicConstraint#getRightFeature()
	 * @see #getBasicConstraint()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link rhea.metamodels.BasicCTCs.impl.RequiresImpl <em>Requires</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see rhea.metamodels.BasicCTCs.impl.RequiresImpl
		 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getRequires()
		...
		/**
		 * The meta object literal for the '{@link rhea.metamodels.BasicCTCs.impl.ExcludesImpl <em>Excludes</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see rhea.metamodels.BasicCTCs.impl.ExcludesImpl
		 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getExcludes()
		...
		/**
		 * The meta object literal for the '{@link rhea.metamodels.BasicCTCs.impl.BasicConstraintImpl <em>Basic Constraint</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see rhea.metamodels.BasicCTCs.impl.BasicConstraintImpl
		 * @see rhea.metamodels.BasicCTCs.impl.BasicCTCsPackageImpl#getBasicConstraint()
