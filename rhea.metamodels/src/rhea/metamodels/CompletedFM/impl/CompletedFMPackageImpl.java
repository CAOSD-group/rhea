...
import rhea.metamodels.CompletedFM.AlternativeGroup;
import rhea.metamodels.CompletedFM.CompletedFMFactory;
...
import rhea.metamodels.CompletedFM.FeatureGroup;
...
import rhea.metamodels.CompletedFM.MutexGroup;
import rhea.metamodels.CompletedFM.SelectionGroup;
 ...
 * @generated
 */
public class CompletedFMPackageImpl extends EPackageImpl implements CompletedFMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see rhea.metamodels.CompletedFM.CompletedFMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CompletedFMPackageImpl() {
		super(eNS_URI, CompletedFMFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link CompletedFMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CompletedFMPackage init() {
		if (isInited) return (CompletedFMPackage)EPackage.Registry.INSTANCE.getEPackage(CompletedFMPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCompletedFMPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CompletedFMPackageImpl theCompletedFMPackage = registeredCompletedFMPackage instanceof CompletedFMPackageImpl ? (CompletedFMPackageImpl)registeredCompletedFMPackage : new CompletedFMPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theCompletedFMPackage.createPackageContents();

		// Initialize created meta-data
		theCompletedFMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCompletedFMPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CompletedFMPackage.eNS_URI, theCompletedFMPackage);
		return theCompletedFMPackage;
	}
	 ...
	 * @generated
	 */
	public CompletedFMFactory getCompletedFMFactory() {
		return (CompletedFMFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		mutexGroupEClass.getESuperTypes().add(this.getFeatureGroup());
		groupCardinalityEClass.getESuperTypes().add(this.getFeatureGroup());
