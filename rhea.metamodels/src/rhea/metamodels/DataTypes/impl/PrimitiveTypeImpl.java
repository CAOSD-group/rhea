 ...
 * </p>
 * <ul>
 *   <li>{@link rhea.metamodels.DataTypes.impl.PrimitiveTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends DataTypeImpl implements PrimitiveType {
	 ...
	 * @ordered
	 */
	protected static final PrimitiveTypeEnum TYPE_EDEFAULT = PrimitiveTypeEnum.BOOLEAN;
	...
	protected EClass eStaticClass() {
		return DataTypesPackage.Literals.PRIMITIVE_TYPE;
	}
	...
	public void setType(PrimitiveTypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.PRIMITIVE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataTypesPackage.PRIMITIVE_TYPE__TYPE:
				return getType();
		}
