 ...
 * </p>
 * <ul>
 *   <li>{@link rhea.metamodels.PropLogicCTCs.impl.AndImpl#getTerms <em>Terms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends TermImpl implements And {
	...
	protected EClass eStaticClass() {
		return PropLogicCTCsPackage.Literals.AND;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PropLogicCTCsPackage.AND__TERMS:
