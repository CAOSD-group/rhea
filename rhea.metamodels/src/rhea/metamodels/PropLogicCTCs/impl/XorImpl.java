 ...
 * </p>
 * <ul>
 *   <li>{@link rhea.metamodels.PropLogicCTCs.impl.XorImpl#getTerms <em>Terms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XorImpl extends TermImpl implements Xor {
	/**
	...
	protected EClass eStaticClass() {
		return PropLogicCTCsPackage.Literals.XOR;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PropLogicCTCsPackage.XOR__TERMS:
