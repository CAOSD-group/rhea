 ...
 * @generated
 */
public class PropLogicCTCsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PropLogicCTCsPackage.ADVANCED_CONSTRAINT: {
			...
			case PropLogicCTCsPackage.TERM: {
