...
public class AbstractVisitor<R,A> implements AllVisitor<R,A> {
    /* Module */
    public R visit(clafer.Absyn.MModule p, A arg) { return visitDefault(p, arg); }
    ...
    /* Clafer */
    public R visit(clafer.Absyn.CClafer p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(clafer.Absyn.Clafer p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* Constraint */
    public R visit(clafer.Absyn.CConstraint p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(clafer.Absyn.Constraint p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* Assertion */
    public R visit(clafer.Absyn.AAssertion p, A arg) { return visitDefault(p, arg); }
    ...
    public R visit(clafer.Absyn.TTransition p, A arg) { return visitDefault(p, arg); }
    ...
    public R visit(clafer.Absyn.AAbstract p, A arg) { return visitDefault(p, arg); }
    ...
    /* NCard */
    public R visit(clafer.Absyn.NNCard p, A arg) { return visitDefault(p, arg); }
    ...
    /* TransGuard */
    public R visit(clafer.Absyn.TTransGuard p, A arg) { return visitDefault(p, arg); }
    ...
    /* Decl */
    public R visit(clafer.Absyn.DDecl p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(clafer.Absyn.Decl p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* VarBinding */
    public R visit(clafer.Absyn.VVarBinding p, A arg) { return visitDefault(p, arg); }
