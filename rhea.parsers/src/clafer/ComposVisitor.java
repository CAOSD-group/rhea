...
{
    /* Module */
    public clafer.Absyn.Module visit(clafer.Absyn.MModule p, A arg)
    {
      ...
      return new clafer.Absyn.MModule(listdeclaration_);
    }
    ...
    /* Clafer */
    public clafer.Absyn.Clafer visit(clafer.Absyn.CClafer p, A arg)
    {
      ...
      return new clafer.Absyn.CClafer(abstract_, listtempmodifier_, gcard_, posident_, super_, reference_, card_, init_, transition_, elements_);
    }

    /* Constraint */
    public clafer.Absyn.Constraint visit(clafer.Absyn.CConstraint p, A arg)
    {
      ...
      return new clafer.Absyn.CConstraint(listexp_);
    }

    /* Assertion */
    public clafer.Absyn.Assertion visit(clafer.Absyn.AAssertion p, A arg)
    {
      clafer.Absyn.ListExp listexp_ = new clafer.Absyn.ListExp();
      for (clafer.Absyn.Exp x : p.listexp_)
      {
      ...
      return new clafer.Absyn.AAssertion(listexp_);
    }
    ...
    public clafer.Absyn.Transition visit(clafer.Absyn.TTransition p, A arg)
    {
      clafer.Absyn.TransArrow transarrow_ = p.transarrow_.accept(this, arg);
      clafer.Absyn.Exp exp_ = p.exp_.accept(this, arg);
      return new clafer.Absyn.TTransition(transarrow_, exp_);
    }
    ...
    public clafer.Absyn.Abstract visit(clafer.Absyn.AAbstract p, A arg)
    {
      return new clafer.Absyn.AAbstract();
    }
    ...
    /* NCard */
    public clafer.Absyn.NCard visit(clafer.Absyn.NNCard p, A arg)
    {
      String posinteger_ = p.posinteger_;
      clafer.Absyn.ExInteger exinteger_ = p.exinteger_.accept(this, arg);
      return new clafer.Absyn.NNCard(posinteger_, exinteger_);
    }
    ...
    /* TransGuard */
    public clafer.Absyn.TransGuard visit(clafer.Absyn.TTransGuard p, A arg)
    {
      clafer.Absyn.Exp exp_ = p.exp_.accept(this, arg);
      return new clafer.Absyn.TTransGuard(exp_);
    }
    ...
    /* Decl */
    public clafer.Absyn.Decl visit(clafer.Absyn.DDecl p, A arg)
    {
      ...
      clafer.Absyn.Exp exp_ = p.exp_.accept(this, arg);
      return new clafer.Absyn.DDecl(listlocid_, exp_);
    }

    /* VarBinding */
    public clafer.Absyn.VarBinding visit(clafer.Absyn.VVarBinding p, A arg)
    {
      clafer.Absyn.LocId locid_ = p.locid_.accept(this, arg);
      clafer.Absyn.Name name_ = p.name_.accept(this, arg);
      return new clafer.Absyn.VVarBinding(locid_, name_);
    }
