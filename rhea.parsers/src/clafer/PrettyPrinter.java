...
public class PrettyPrinter
{
  ...
  {
    if (foo instanceof clafer.Absyn.MModule)
    {
       clafer.Absyn.MModule _mmodule = (clafer.Absyn.MModule) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_mmodule.listdeclaration_, 0);
  ...
  {
    if (foo instanceof clafer.Absyn.CClafer)
    {
       clafer.Absyn.CClafer _cclafer = (clafer.Absyn.CClafer) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_cclafer.abstract_, 0);
       pp(_cclafer.listtempmodifier_, 0);
       pp(_cclafer.gcard_, 0);
       pp(_cclafer.posident_, 0);
       pp(_cclafer.super_, 0);
       pp(_cclafer.reference_, 0);
       pp(_cclafer.card_, 0);
       pp(_cclafer.init_, 0);
       pp(_cclafer.transition_, 0);
       pp(_cclafer.elements_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  {
    if (foo instanceof clafer.Absyn.CConstraint)
    {
       clafer.Absyn.CConstraint _cconstraint = (clafer.Absyn.CConstraint) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("[");
       pp(_cconstraint.listexp_, 0);
       render("]");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  {
    if (foo instanceof clafer.Absyn.AAssertion)
    {
       clafer.Absyn.AAssertion _aassertion = (clafer.Absyn.AAssertion) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("assert");
       render("[");
       pp(_aassertion.listexp_, 0);
       render("]");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(clafer.Absyn.Transition foo, int _i_)
  {
    ...
    else     if (foo instanceof clafer.Absyn.TTransition)
    {
       clafer.Absyn.TTransition _ttransition = (clafer.Absyn.TTransition) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_ttransition.transarrow_, 0);
       pp(_ttransition.exp_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(clafer.Absyn.Abstract foo, int _i_)
  {
    ...
    else     if (foo instanceof clafer.Absyn.AAbstract)
    {
       clafer.Absyn.AAbstract _aabstract = (clafer.Absyn.AAbstract) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("abstract");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  {
    if (foo instanceof clafer.Absyn.NNCard)
    {
       clafer.Absyn.NNCard _nncard = (clafer.Absyn.NNCard) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_nncard.posinteger_, 0);
       render("..");
       pp(_nncard.exinteger_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  {
    if (foo instanceof clafer.Absyn.TTransGuard)
    {
       clafer.Absyn.TTransGuard _ttransguard = (clafer.Absyn.TTransGuard) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_ttransguard.exp_, 1);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  {
    if (foo instanceof clafer.Absyn.DDecl)
    {
       clafer.Absyn.DDecl _ddecl = (clafer.Absyn.DDecl) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_ddecl.listlocid_, 0);
       render(":");
       pp(_ddecl.exp_, 21);
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  {
    if (foo instanceof clafer.Absyn.VVarBinding)
    {
       clafer.Absyn.VVarBinding _vvarbinding = (clafer.Absyn.VVarBinding) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_vvarbinding.locid_, 0);
       render("=");
       pp(_vvarbinding.name_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void sh(clafer.Absyn.Clafer foo)
  {
    if (foo instanceof clafer.Absyn.CClafer)
    {
       ...
       render("(");
       render("CClafer");
       sh(_cclafer.abstract_);
       render("[");
       sh(_cclafer.listtempmodifier_);
       render("]");
       sh(_cclafer.gcard_);
       sh(_cclafer.posident_);
       sh(_cclafer.super_);
       sh(_cclafer.reference_);
       sh(_cclafer.card_);
       sh(_cclafer.init_);
       sh(_cclafer.transition_);
       sh(_cclafer.elements_);
       render(")");
    }
  }
  ...
  private static void sh(clafer.Absyn.Transition foo)
  {
    ...
    if (foo instanceof clafer.Absyn.TTransition)
    {
       clafer.Absyn.TTransition _ttransition = (clafer.Absyn.TTransition) foo;
       render("(");
       render("TTransition");
       sh(_ttransition.transarrow_);
       sh(_ttransition.exp_);
       render(")");
    }
  }
  ...
  private static void sh(clafer.Absyn.Abstract foo)
  {
    ...
    if (foo instanceof clafer.Absyn.AAbstract)
    {
       clafer.Absyn.AAbstract _aabstract = (clafer.Absyn.AAbstract) foo;
       render("AAbstract");
    }
  ...
  private static void sh(clafer.Absyn.NCard foo)
  {
    if (foo instanceof clafer.Absyn.NNCard)
    {
       ...
       render("(");
       render("NNCard");
       sh(_nncard.posinteger_);
       sh(_nncard.exinteger_);
       render(")");
    }
  }
  ...
  private static void sh(clafer.Absyn.VarBinding foo)
  {
    if (foo instanceof clafer.Absyn.VVarBinding)
    {
       ...
       render("(");
       render("VVarBinding");
       sh(_vvarbinding.locid_);
       sh(_vvarbinding.name_);
       render(")");
    }
  }
