...
public class VisitSkel
{
  ...
  {
    public R visit(clafer.Absyn.MModule p, A arg)
    { /* Code for MModule goes here */
  ...
  {
    public R visit(clafer.Absyn.CClafer p, A arg)
    { /* Code for CClafer goes here */
  ...
  {
    public R visit(clafer.Absyn.CConstraint p, A arg)
    { /* Code for CConstraint goes here */
  ...
  {
    public R visit(clafer.Absyn.AAssertion p, A arg)
    { /* Code for AAssertion goes here */
      for (clafer.Absyn.Exp x: p.listexp_) {
        x.accept(new ExpVisitor<R,A>(), arg);
      }
      return null;
  ...
  public class TransitionVisitor<R,A> implements clafer.Absyn.Transition.Visitor<R,A>
  {
    ...
    public R visit(clafer.Absyn.TTransition p, A arg)
    { /* Code for TTransition goes here */
  ...
  public class AbstractVisitor<R,A> implements clafer.Absyn.Abstract.Visitor<R,A>
  {
    ...
    public R visit(clafer.Absyn.AAbstract p, A arg)
    { /* Code for AAbstract goes here */
      return null;
    }
  }
  ...
  {
    public R visit(clafer.Absyn.NNCard p, A arg)
    { /* Code for NNCard goes here */
      //p.posinteger_;
  ...
  {
    public R visit(clafer.Absyn.TTransGuard p, A arg)
    { /* Code for TTransGuard goes here */
      p.exp_.accept(new ExpVisitor<R,A>(), arg);
      return null;
    }
  }
  ...
  {
    public R visit(clafer.Absyn.DDecl p, A arg)
  ...
  {
    public R visit(clafer.Absyn.VVarBinding p, A arg)
    { /* Code for VVarBinding goes here */
