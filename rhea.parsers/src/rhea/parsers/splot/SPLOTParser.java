...
public class SPLOTParser implements FMParser {

	@Override
	public rhea.metamodels.BasicFMs.FeatureModel readFeatureModel(String filepath) {
		try {
			String featureModelFile = filepath;
