 ...
 * </p>
 * <ul>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureImpl#getId <em>Id</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureImpl#isMandatory <em>Mandatory</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link uma.caosd.rhea.metamodels.BasicFMs.impl.FeatureImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BasicFMsPackage.FEATURE___IS_LEAF:
				return isLeaf();
			case BasicFMsPackage.FEATURE___IS_ROOT:
				return isRoot();
		}
