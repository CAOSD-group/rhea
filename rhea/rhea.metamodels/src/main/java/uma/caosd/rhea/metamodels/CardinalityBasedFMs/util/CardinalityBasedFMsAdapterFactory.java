/**
 */
package uma.caosd.rhea.metamodels.CardinalityBasedFMs.util;
...
import uma.caosd.rhea.metamodels.CardinalityBasedFMs.*;
 ...
 * <!-- end-user-doc -->
 * @see uma.caosd.rhea.metamodels.CardinalityBasedFMs.CardinalityBasedFMsPackage
 * @generated
 */
public class CardinalityBasedFMsAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link uma.caosd.rhea.metamodels.CardinalityBasedFMs.Multiplicity <em>Multiplicity</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link uma.caosd.rhea.metamodels.CardinalityBasedFMs.GroupCardinality <em>Group Cardinality</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
